...
public class Sample_MeshCut2 : MonoBehaviour
{
    ...
    public void Cut(Plane cutPlane)
    {
        ...
        GameObject obj = new GameObject("cut obj", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(Sample_MeshCut2));
        var mesh = new Mesh();
        ...
        obj.GetComponent<Sample_MeshCut2>().skinWidth = skinWidth;

        GameObject obj2 = new GameObject("cut obj", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(Sample_MeshCut2));
        var mesh2 = new Mesh();
        ...
        obj2.GetComponent<Sample_MeshCut2>().skinWidth = skinWidth;
